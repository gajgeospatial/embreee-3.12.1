//
// .\quaternion_motion_blur_device_ispc_avx2.h
...
extern "C" {
    ...
    extern void device_render(int32_t * pixels, const uint32_t width, const uint32_t height, const float time, const struct ISPCCamera &camera);
