...
#ifndef __ISPC_ENUM_ISPCType__
#define __ISPC_ENUM_ISPCType__
enum ISPCType {
    TRIANGLE_MESH = 0,
    SUBDIV_MESH = 1,
    CURVES = 2,
...
#ifndef __ISPC_STRUCT_LinearSpace3fa__
#define __ISPC_STRUCT_LinearSpace3fa__
...
#ifndef __ISPC_STRUCT_AffineSpace3fa__
#define __ISPC_STRUCT_AffineSpace3fa__
struct AffineSpace3fa {
    struct LinearSpace3fa l;
    struct Vec3fa p;
};
#endif

#ifndef __ISPC_STRUCT_ISPCCamera__
#define __ISPC_STRUCT_ISPCCamera__
struct ISPCCamera {
    struct AffineSpace3fa xfm;
};
#endif
...
#ifndef __ISPC_STRUCT_ISPCScene__
#define __ISPC_STRUCT_ISPCScene__
struct ISPCScene {
    struct ISPCGeometry *  * geometries;
    struct ISPCMaterial *  * materials;
...
#ifndef __ISPC_STRUCT_ISPCGeometry__
#define __ISPC_STRUCT_ISPCGeometry__
struct ISPCGeometry {
    enum ISPCType type;
...
#ifndef __ISPC_STRUCT_ISPCMaterial__
#define __ISPC_STRUCT_ISPCMaterial__
struct ISPCMaterial {
    int32_t type;
    int32_t align[3];
};
...
struct Light {
    struct v8_varying_Light_SampleRes ( * sample)(const struct Light * self, const struct v8_varying_DifferentialGeometry &dg, const struct v8_varying_Vec2f &s);
    struct v8_varying_Light_EvalRes ( * eval)(const struct Light * self, const struct v8_varying_DifferentialGeometry &dg, const struct v8_varying_Vec3f &dir);
};
#endif
...
extern "C" {
#endif // __cplusplus
    extern bool device_pick(const float x, const float y, const struct ISPCCamera &camera, struct Vec3f &hitPos);
    extern void renderFrameAmbientOcclusion(int32_t * pixels, const uint32_t width, const uint32_t height, const float time, const struct ISPCCamera &camera);
    extern void renderFrameCycles(int32_t * pixels, const uint32_t width, const uint32_t height, const float time, const struct ISPCCamera &camera);
    extern void renderFrameDifferentials(int32_t * pixels, const uint32_t width, const uint32_t height, const float time, const struct ISPCCamera &camera);
    extern void renderFrameEyeLight(int32_t * pixels, const uint32_t width, const uint32_t height, const float time, const struct ISPCCamera &camera);
    extern void renderFrameGeomID(int32_t * pixels, const uint32_t width, const uint32_t height, const float time, const struct ISPCCamera &camera);
    extern void renderFrameGeomIDPrimID(int32_t * pixels, const uint32_t width, const uint32_t height, const float time, const struct ISPCCamera &camera);
    extern void renderFrameNg(int32_t * pixels, const uint32_t width, const uint32_t height, const float time, const struct ISPCCamera &camera);
    extern void renderFrameOcclusion(int32_t * pixels, const uint32_t width, const uint32_t height, const float time, const struct ISPCCamera &camera);
    extern void renderFrameStandard(int32_t * pixels, const uint32_t width, const uint32_t height, const float time, const struct ISPCCamera &camera);
    extern void renderFrameTexCoords(int32_t * pixels, const uint32_t width, const uint32_t height, const float time, const struct ISPCCamera &camera);
    extern void renderFrameUV(int32_t * pixels, const uint32_t width, const uint32_t height, const float time, const struct ISPCCamera &camera);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
